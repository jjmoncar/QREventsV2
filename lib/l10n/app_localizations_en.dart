...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get status_invited => 'Invited';

  @override
  String get status_checked_in => 'Attended';
  ...
  String invitationMessage(String guestName, String eventName) {
    return 'Hi $guestName! You are invited to $eventName. Your QR invitation is attached.';
  }
  ...
  String invitationWedding(String guestName, String eventName) {
    return 'Hi $guestName! We are happy to invite you to our Wedding: $eventName. Please present the attached QR pass upon entry.';
  }

  @override
  String invitationBirthday(String guestName, String eventName) {
    return 'Hi $guestName! I\'m waiting for you to celebrate my birthday: $eventName. Your QR pass is attached.';
  }

  @override
  String invitationCorporate(String guestName, String eventName) {
    return 'Dear $guestName, you are formally invited to our corporate event: $eventName. Your QR access pass is attached.';
  }
  ...
  @override
  String get loginRequired => 'You must be logged in to view your profile';

  @override
  String get errorEmailAlreadyRegistered => 'Email already registered. Please log in.';

  @override
  String get scanTooEarly => 'Access will be enabled one hour before the start';

  @override
  String get scanTooLate => 'The event has ended and no longer admits more entries';

  @override
  String get sendInvitationEmail => 'Send Invitation via Email';

  @override
  String get sendInvitationImageSubtitle => 'Send QR code as an image';

  @override
  String scanPreviousDay(String date) {
    return 'The event has not started yet. Scheduled date: $date';
  }
}
